...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_rep(self):
        ...
        plc = Place()
        plc.id = "123456"
        plc.created_at = plc.updated_at = d_time
        plcstr = plc.__str__()
        self.assertIn("[Place] (123456)", plcstr)
        self.assertIn("'id': '123456'", plcstr)
        self.assertIn("'created_at': " + d_time_rep, plcstr)
        self.assertIn("'updated_at': " + d_time_rep, plcstr)
    ...
    def test_init_with_kwargs(self):
        ...
        plc = Place(id="345", created_at=d_time_iso, updated_at=d_time_iso)
        self.assertEqual(plc.id, "345")
        self.assertEqual(plc.created_at, d_time)
        self.assertEqual(plc.updated_at, d_time)
...
class TestPlace_save(unittest.TestCase):
    ...
    def test_one_save(self):
        plc = Place()
        sleep(0.05)
        fst_updated_at = plc.updated_at
        plc.save()
        self.assertLess(fst_updated_at, plc.updated_at)
    ...
    def test_two_saves(self):
        ...
        fst_updated_at = plc.updated_at
        plc.save()
        sec_updated_at = plc.updated_at
        self.assertLess(fst_updated_at, sec_updated_at)
        sleep(0.05)
        plc.save()
        self.assertLess(sec_updated_at, plc.updated_at)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(plc.to_dict(), ts_dict)
