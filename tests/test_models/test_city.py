...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_state_id_is_public_class_attr(self):
        cty = City()
    ...
    def test_str_rep(self):
        ...
        self.assertIn("'created_at': " + d_time_rep, cystr)
        self.assertIn("'updated_at': " + d_time_rep, cystr)
...
class TestCity_save(unittest.TestCase):
    ...
    def test_one_save(self):
        cty = City()
        sleep(0.05)
        fst_updated_at = cty.updated_at
        cty.save()
        self.assertLess(fst_updated_at, cty.updated_at)
    ...
    def test_two_saves(self):
        ...
        fst_updated_at = cty.updated_at
        cty.save()
        sec_updated_at = cty.updated_at
        self.assertLess(fst_updated_at, sec_updated_at)
        sleep(0.05)
        cty.save()
        self.assertLess(sec_updated_at, cty.updated_at)
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(cty.to_dict(), ts_dict)
