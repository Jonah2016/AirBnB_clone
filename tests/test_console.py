...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_update(self):
        hlp = ("Usage: update <class> <id> <attribute_name>"
               " <attribute_value> or"
               "\n       <class>.update(<id>, <attribute_name>,"
               " <attribute_value"
               ">) or\n       <class>.update(<id>, <dictionary>)\n        "
               "Update a class instance of a given id by creating"
               " or updating\n   "
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testingId = output.getvalue().strip()
            testingCmd = "update BaseModel {}".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            testingId = output.getvalue().strip()
            testingCmd = "update User {}".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            testingId = output.getvalue().strip()
            testingCmd = "update State {}".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
            testingId = output.getvalue().strip()
            testingCmd = "update City {}".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testingId = output.getvalue().strip()
            testingCmd = "update Amenity {}".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            testingId = output.getvalue().strip()
            testingCmd = "update Place {}".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_missing_attr_name_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testingId = output.getvalue().strip()
            testingCmd = "BaseModel.update({})".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            testingId = output.getvalue().strip()
            testingCmd = "User.update({})".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            testingId = output.getvalue().strip()
            testingCmd = "State.update({})".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
            testingId = output.getvalue().strip()
            testingCmd = "City.update({})".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testingId = output.getvalue().strip()
            testingCmd = "Amenity.update({})".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            testingId = output.getvalue().strip()
            testingCmd = "Place.update({})".format(testingId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_missing_attr_value_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update BaseModel {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update User {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update State {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update City {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update Amenity {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update Place {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "update Review {} attr_name".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_missing_attr_value_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "BaseModel.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "User.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "State.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "City.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "Amenity.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "Place.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testingId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testingCmd = "Review.update({}, attr_name)".format(testingId)
            self.assertFalse(HBNBCommand().onecmd(testingCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_valid_string_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testingId = output.getvalue().strip()
        testingCmd = "update BaseModel {} attr_name 'attr_value'"
        .format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["BaseModel.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testingId = output.getvalue().strip()
        testingCmd = "update User {} attr_name 'attr_value'".format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["User.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            testingId = output.getvalue().strip()
        testingCmd = "update State {} attr_name 'attr_value'".format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["State.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            testingId = output.getvalue().strip()
        testingCmd = "update City {} attr_name 'attr_value'".format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["City.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testingId = output.getvalue().strip()
        testingCmd = "update Place {} attr_name 'attr_value'".format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Place.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            testingId = output.getvalue().strip()
        testingCmd = "update Amenity {} attr_name 'attr_value'"
        .format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Amenity.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testingId = output.getvalue().strip()
        testingCmd = "update Review {} attr_name 'attr_value'"
        .format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Review.{}".format(testingId)].__dict__
    ...
    def test_update_valid_string_attr_dot_notation(self):
        ...
        testingCmd = "BaseModel.update({}, attr_name, 'attr_value')"
        .format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["BaseModel.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            tstId = output.getvalue().strip()
        testingCmd = "User.update({}, attr_name, 'attr_value')".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["User.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            tstId = output.getvalue().strip()
        testingCmd = "State.update({}, attr_name, 'attr_value')".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["State.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            tstId = output.getvalue().strip()
        testingCmd = "City.update({}, attr_name, 'attr_value')".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["City.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tstId = output.getvalue().strip()
        testingCmd = "Place.update({}, attr_name, 'attr_value')".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            tstId = output.getvalue().strip()
        testingCmd = "Amenity.update({}, attr_name, 'attr_value')"
        .format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Amenity.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            tstId = output.getvalue().strip()
        testingCmd = "Review.update({}, attr_name, 'attr_value')".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Review.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
    ...
    def test_update_valid_int_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testingId = output.getvalue().strip()
        testingCmd = "update Place {} max_guest 98".format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Place.{}".format(testingId)].__dict__
    ...
    def test_update_valid_int_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tstId = output.getvalue().strip()
        testingCmd = "Place.update({}, max_guest, 98)".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual(98, test_dict["max_guest"])
    ...
    def test_update_valid_float_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testingId = output.getvalue().strip()
        testingCmd = "update Place {} latitude 7.2".format(testingId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Place.{}".format(testingId)].__dict__
    ...
    def test_update_valid_float_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tstId = output.getvalue().strip()
        testingCmd = "Place.update({}, latitude, 7.2)".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(testingCmd))
        test_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual(7.2, test_dict["latitude"])
    ...
    def test_update_valid_dictionary_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testingId = output.getvalue().strip()
        testingCmd = "update BaseModel {} ".format(testingId)
        testingCmd += "{'attr_name': 'attr_value'}"
        HBNBCommand().onecmd(testingCmd)
        test_dict = storage.all()["BaseModel.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testingId = output.getvalue().strip()
        testingCmd = "update Review {} ".format(testingId)
        testingCmd += "{'attr_name': 'attr_value'}"
        HBNBCommand().onecmd(testingCmd)
        test_dict = storage.all()["Review.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

    def test_update_valid_dict_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testingId = output.getvalue().strip()
        testingCmd = "BaseModel.update({}".format(testingId)
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testingId = output.getvalue().strip()
        testingCmd = "Review.update({}, ".format(testingId)
        testingCmd += "{'attr_name': 'attr_value'})"
        HBNBCommand().onecmd(testingCmd)
        test_dict = storage.all()["Review.{}".format(testingId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
